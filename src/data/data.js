const products = [
    ...
    },
    {
      id: 7,
      images: [
        '/images/smartwatches/T20ultra2-1.JPG',
        '/images/smartwatches/T20ultra2-2.JPG',
        '/images/smartwatches/T20ultra2-3.JPG',
        '/images/smartwatches/T20ultra2-4.JPG'
      ],
      title: 'T20 Ultra Smartwatch',
      price: '900af',
      specification: {
        dari: [
          "تماس‌های بی‌سیم: زنگ‌ها را از ساعت خود بدون نیاز به گوشی مدیریت کنید.",
          "ردیابی فعالیت‌ها: قدم‌ها، فاصله و کالری مصرف‌شده را بررسی کنید و سلامتی‌تان را بهبود ببخشید.",
          "صفحه‌های شخصی: ساعت خود را با تصاویر جدید و دلخواه تنظیم کنید.",
          "ویژگی‌های پیشرفته: پایش ضربان قلب، اندازه‌گیری اکسیژن خون، ردیابی خواب، هشدار نشستن، ساعت، وضعیت هوا، کنترل موسیقی و کنترل دوربین از راه دور."
        ],
        pashto: [
          "وایرلس اړیکې: د ساعت له لارې زنګونه وکړئ او ترلاسه کړئ پرته له دې چې ټیلیفون راوخلئ.",
          "فعالیت څارنه: ګامونه، فاصله، او کالوري سوځېدنه وڅارئ او خپل روغتیا ته وده ورکړئ.",
          "شخصي صفحه‌: خپل ساعت د خپل سټایل مطابق د نوو شالیدونو سره جوړ کړئ.",
          "پرمختللې ځانګړتیاوې: د زړه ضربان، وینې اکسیجن، خوب څارنه، خبرداری، ساعت، هوا، موسیقي کنټرول، او کیمره لرې کنټرول څخه خوند واخلئ."
      ],
      }
    }
  ];
